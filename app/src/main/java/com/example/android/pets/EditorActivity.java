...
public class EditorActivity extends AppCompatActivity implements
    ...
    private void savePet() {
        ...
        //Если это услочие поставить в конце метода - будет срабоатывать инсерт пустой строки в БД
        if (mCurrentPetUri == null &&
        ...
        if (mCurrentPetUri == null) {
            ...
            if (newUri == null) {
                ...
                Toast.makeText(this, getString(R.string.fail_added_pet),
                        Toast.LENGTH_SHORT).show();
            } else {
                // Otherwise, the insertion was successful and we can display a toast.
                Toast.makeText(this, getString(R.string.success_added_pet),
                        Toast.LENGTH_SHORT).show();
            }
        } else {
            ...
            if (rowsAffected == 0) {
                ...
                Toast.makeText(this, getString(R.string.fail_edit_pet),
                        Toast.LENGTH_SHORT).show();
            } else {
                // Otherwise, the update was successful and we can display a toast.
                Toast.makeText(this, getString(R.string.success_edit_pet),
                        Toast.LENGTH_SHORT).show();
            }
        }
    }
